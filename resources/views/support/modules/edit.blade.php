        ...
        <div class="card mt-2">
            <div class="card-header">
                <h5 class="mb-4">
                    ...
                    Edit Module
                    <a href="{{ route('lms.support-modules') }}" class="btn btn-dark float-end"> <i
                            class="fa fa-list text-warning"></i> All Modules </a>
                        ...
                        <div>
                            @foreach ($institutes as $institute)
                                <div class="form-check text-dark">
                                    <input type="checkbox" name="institutes[]" id="institute{{ $institute->id }}"
                                        value="{{ $institute->id }}"
                                        {{ in_array($institute->id, $selectedInstitutes) ? 'checked' : '' }}>
