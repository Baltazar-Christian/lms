    ...
    <div class="container mt-2">
        <div class="card">
            <div class="card-header">
                <h5>Create Sub-Section

                    <a href="{{ route('lms.support-show-course-content', ['courseId' => $course->id, 'contentId' => $parentContent->id]) }}"
            ...
            <div class="card-body">
                <form
                    action="{{ route('lms.support-save-subsection', ['courseId' => $course->id, 'parentId' => $parentContent->id]) }}"
