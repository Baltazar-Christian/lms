        ...
        <div class="card">
            ...
            <div class="card-header">
                <h5 >
                    ...
                    Edit Course
                    <a href="{{ route('lms.tutor-view-module',$course->module_id) }}" class="btn btn-dark float-end">
            ...
            <div class="card-body">
                <form action="{{ route('lms.update-tutor-course', $course->id) }}" method="post" enctype="multipart/form-data">
                    @csrf
