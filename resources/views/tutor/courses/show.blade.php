                ...
                <div class="col-4 mx-auto mt-4">
                    @if ($course->cover_image)
                        <img src="{{ asset('public/storage/covers/' . $course->cover_image) }}"
                            alt="{{ $course->title }} Cover Image" height="200px" width="200px"
                ...
                <div class="col-lg-12">
                    ...
                    <div class="block block-rounded">
                        <ul class="nav nav-tabs nav-tabs-block justify-content-end" role="tablist">
                            ...
                            <li class="nav-item">
                                <button class=" btn btn-dark btn-sm active mx-1" id="btabs-static2-home-tab" data-bs-toggle="tab"
                            ...
                            <li class="nav-item">
                                <button class=" btn btn-dark btn-sm" id="btabs-static2-profile-tab" data-bs-toggle="tab"
                                    ...
                                    aria-controls="btabs-static2-profile" aria-selected="false">
                        ...
                        <div class="block-content tab-content">
                            ...
                            <div class="tab-pane table-responsive active" id="btabs-static2-home" role="tabpanel"
                                ...
                                <h6 class="mt-4 mb-3"> <i class="fa fa-list text-warning"></i> Course Contents
                                    <a href="{{ route('lms.tutor-courses.create-content', $course->id) }}"
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a class="fw-medium text-dark"
                                                        href="{{ route('lms.tutor-show-course-content', ['courseId' => $course->id, 'contentId' => $content->id]) }}">{{ $content->title }}</a>
                                                </td>
